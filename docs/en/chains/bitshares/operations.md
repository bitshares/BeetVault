...
This page lists the operations BeetVault can process for BitShares. Each corresponds to an action a third-party application may request, and every request must be approved before it is broadcast.
...
| `signNFT` | Sign NFT Request | Sign an NFTs contents |
