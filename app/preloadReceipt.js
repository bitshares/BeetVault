...
electron__WEBPACK_IMPORTED_MODULE_0__.contextBridge.exposeInMainWorld('electron', {
    ...
    getReceipt: (id) => {
        (0,_lib_ipcWrapper_js__WEBPACK_IMPORTED_MODULE_1__.safeSend)(`get:receipt:${id}`);
    },
    onReceipt: (id, func) => {
        (0,_lib_ipcWrapper_js__WEBPACK_IMPORTED_MODULE_1__.safeOn)(`respond:receipt:${id}`, func);
    },
});
...
/******/ })()
;
//# sourceMappingURL=preloadReceipt.js.map