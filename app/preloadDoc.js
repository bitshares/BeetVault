...
electron__WEBPACK_IMPORTED_MODULE_0__.contextBridge.exposeInMainWorld('electron', {
    ...
    openURL: (target) => (0,_lib_ipcWrapper_js__WEBPACK_IMPORTED_MODULE_1__.safeSend)('openURL', target),
    createDoc: (arg) => (0,_lib_ipcWrapper_js__WEBPACK_IMPORTED_MODULE_1__.safeSend)('createDoc', arg),
    readDoc: (arg) => (0,_lib_ipcWrapper_js__WEBPACK_IMPORTED_MODULE_1__.safeInvoke)('readDoc', arg),
    readManifest: () => (0,_lib_ipcWrapper_js__WEBPACK_IMPORTED_MODULE_1__.safeInvoke)('readManifest'),
    sendError: (errorData) => (0,_lib_ipcWrapper_js__WEBPACK_IMPORTED_MODULE_1__.safeSend)('sendError', errorData),
});
...
/******/ })()
;
//# sourceMappingURL=preloadDoc.js.map